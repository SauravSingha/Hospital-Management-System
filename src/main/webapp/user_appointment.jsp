...
.backImg {
	background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),
		url("https://live.staticflickr.com/7334/12824282483_8aca52f0ba_b.jpg");
	height: 20vh;
	width: 100%;
	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="https://th.bing.com/th/id/OIP.mR4cxQt6AXPvO7Xz5nPa2AHaHp?rs=1&pid=ImgDetMain">
			</div>
